...
public class Contratista extends Persona implements Firma {
    ...
    public String toString() {
        return "Contratista{" + "firma=" + firma + '}';
    }
